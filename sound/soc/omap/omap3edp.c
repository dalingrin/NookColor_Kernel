...
#ifdef CONFIG_SND_SOC_TLV320AIC3111
  #include "../codecs/tlv320aic3111.h"
#endif
#ifdef CONFIG_SND_SOC_DAC3100
...
static struct snd_soc_dai_link omap3edp_dai = {
	.name = "TLV320AIC3111",
	.stream_name = "AIC3111",
	.codec_dai = &tlv320aic3111_dai,
	.init = omap3edp_aic3111_init,
	.cpu_dai = &omap_mcbsp_dai[0],
	.ops = &omap3edp_ops,
};
#elif defined CONFIG_SND_SOC_DAC3100
static struct snd_soc_dai_link omap3edp_dai = {
	.name = "TLV320DAC3100",
	.stream_name = "DAC3100",
	.codec_dai = &dac3100_dai,
...
#ifdef CONFIG_SND_SOC_TLV320AIC3111
    .codec_dev = &soc_codec_dev_aic3111,
#elif defined CONFIG_SND_SOC_TLV320DAC3100
